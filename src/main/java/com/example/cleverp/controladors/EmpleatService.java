...
import com.example.cleverp.Interface.EmpleatInterface;
 ...
 */
@Service("empleatDetailsService")
@Slf4j
public class EmpleatService implements UserDetailsService,EmpleatInterface {
    ...
    @Autowired
    private EmpleatDAO empleado;

    @Override
    @Transactional
    public List<Empleat> listarEmpleats() {
        return (List<Empleat>) empleado.findAll();
    }

    @Override
    @Transactional
    public void addEmpleat(Empleat empleado) {
        this.empleado.save(empleado);
    }

    @Override
    @Transactional
    public void eliminarEmpleat(Empleat empleado) {
        this.empleado.delete(empleado);
    }

    @Override
    @Transactional
    public Empleat buscarEmpleat(Empleat empleado) {
        return this.empleado.findById(empleado.getIdUsuari()).orElse(null);
    }
